...
class FibonacciProduct extends Component {
  render() {
...
FibonacciProduct.propTypes = {
  data: PropTypes.object.isRequired
}

export default FibonacciProduct

export const pageQuery = graphql`
  query fibonacciQuery($slug: String!){
    contentfulFibonacci(slug: {eq: $slug}) {
      title
      slug
      price
      category
